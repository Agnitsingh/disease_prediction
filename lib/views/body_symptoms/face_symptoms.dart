...
class FaceSymptomPage extends StatefulWidget {
  @override
  _FaceSymptomPageState createState() => _FaceSymptomPageState();
}

class _FaceSymptomPageState extends State<FaceSymptomPage> {
