...
class HeartSymptomPage extends StatefulWidget {
  @override
  _HeartSymptomPageState createState() => _HeartSymptomPageState();
}

class _HeartSymptomPageState extends State<HeartSymptomPage> {
