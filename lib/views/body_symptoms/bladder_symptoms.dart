...
class BladderSymptomPage extends StatefulWidget {
  @override
  _BladderSymptomPageState createState() => _BladderSymptomPageState();
}

class _BladderSymptomPageState extends State<BladderSymptomPage> {
  Map<String, bool?> selectedSymptoms = {
    ...
    "Anal Region Pain": false,
    "Anus Irritation": false,
