...
class OtherSymptomPage extends StatefulWidget {
  @override
  _OtherSymptomPageState createState() => _OtherSymptomPageState();
}

class _OtherSymptomPageState extends State<OtherSymptomPage> {
