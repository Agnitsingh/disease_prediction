...
class MuscleSymptomPage extends StatefulWidget {
  @override
  _MuscleSymptomPageState createState() => _MuscleSymptomPageState();
}

class _MuscleSymptomPageState extends State<MuscleSymptomPage> {
