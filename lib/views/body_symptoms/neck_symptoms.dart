...
class NeckSymptomPage extends StatefulWidget {
  @override
  _NeckSymptomPageState createState() => _NeckSymptomPageState();
}

class _NeckSymptomPageState extends State<NeckSymptomPage> {
