...
class EyesSymptomPage extends StatefulWidget {
  @override
  _EyesSymptomPageState createState() => _EyesSymptomPageState();
}

class _EyesSymptomPageState extends State<EyesSymptomPage> {
  Map<String, bool?> selectedSymptoms = {
    "Eyes Redness": false,
    "Fatigue": false,
    "Lethargy": false,
    "Sunken Eyes": false,
    "Pain Behind Eyes": false,
