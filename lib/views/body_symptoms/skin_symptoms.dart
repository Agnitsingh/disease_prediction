...
class SkinSymptomPage extends StatefulWidget {
  @override
  _SkinSymptomPageState createState() => _SkinSymptomPageState();
}

class _SkinSymptomPageState extends State<SkinSymptomPage> {
