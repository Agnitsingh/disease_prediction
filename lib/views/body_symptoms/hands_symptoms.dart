...
class HandSymptomPage extends StatefulWidget {
  @override
  _HandSymptomPageState createState() => _HandSymptomPageState();
}

class _HandSymptomPageState extends State<HandSymptomPage> {
